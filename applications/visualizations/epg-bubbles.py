...
if __name__ == '__main__':
    description = 'Endpoints per EPG bubble chart visualization'
    creds = Credentials(('apic', 'server'), description)
    args = creds.get()

    print 'Getting data from APIC....'
    get_data_from_apic(args.url, args.login, args.password)

    print 'Running server. Point your browser to http://%s:%s'% (args.ip, args.port)
